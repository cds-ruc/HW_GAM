...
//#include "mcs/mcslet_client/mcslet_client.h"
#include "mcs/util/util.h"

//ToDo(这里出现了重复定义导致编译报错)
...
/// Information about a remote function.
        ...
        public:
            McsFunction() {}
            McsFunction(Language language, const FunctionDescriptor &function_descriptor)
