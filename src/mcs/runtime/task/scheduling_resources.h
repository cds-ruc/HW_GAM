...
//#include "mcs/mcslet/format/node_manager_generated.h"
//#include "mcs/mcslet/scheduling/cluster_resource_data.h"
...
namespace std {
    template <>
    struct hash<mcs::ResourceSet> {
        size_t operator()(mcs::ResourceSet const &k) const {
